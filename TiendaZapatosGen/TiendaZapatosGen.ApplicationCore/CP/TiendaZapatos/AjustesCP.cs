...
{
public partial class AjustesCP : GenericBasicCP
{
public AjustesCP(GenericSessionCP currentSession)
        : base (currentSession)
{
}

public AjustesCP(GenericSessionCP currentSession, GenericUnitOfWorkUtils unitUtils)
